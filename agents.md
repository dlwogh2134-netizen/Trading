...
5. **디자인 시스템 엄격 준수**: UI를 개발할 때 [design.md](design.md)에 명시된 Obsidian Navy 배경, JetBrains Mono 폰트 사용처, Glassmorphism, 2px Cyan 매매 승인 카드 왼쪽 강조 테두리 등 모든 스타일 토큰을 정교하게 적용하십시오.
